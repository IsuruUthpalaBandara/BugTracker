...
localStorage.setItem("demo",JSON.stringify(currentProject))
console.log("demo=>",currentProject)
...
console.log("savedAll as=>",localStorage.getItem("demo"))
...
useEffect(()=>{
setCurrentProject(JSON.parse(localStorage.getItem('demo')))
})
